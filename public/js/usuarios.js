...
document.addEventListener('DOMContentLoaded', async () => {
    try {
        ...
        if (response.ok) {
            ...
            sessionStorage.setItem('nombreUsuario', userData.nombreUsuario);
            sessionStorage.setItem('biografia', userData.biografia || '');
...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    biografiaForm.addEventListener('submit', async (e) => {
        ...
        try {
            ...
            if (response.ok) {
                alert('Biografía actualizada');
                // Actualizar la biografía en sessionStorage
...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    deleteBiografiaButton.addEventListener('click', async () => {
        try {
            ...
            if (response.ok && result.success) {
                alert(result.message);
                // Limpiar la biografía en sessionStorage
    ...
    deleteButton.addEventListener('click', async () => {
        try {
            ...
            if (response.ok) {
                ...
                sessionStorage.clear(); // Limpiar sessionStorage al eliminar usuario
